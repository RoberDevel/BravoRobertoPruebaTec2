<%@page import="com.trabajos.gestionturnos.logic.Ciudadano"%>
...
<html>
    ...
    <body>
        <div class="row" style="height: 100%; background-color: coral">
            ...
            <% if (request.getAttribute("ciudadano") != null) {%>
            <div class="col-8" >
                ...
                <p style=" color: white; text-align: center; font-size: 32px;">Error: Ciudadano ya existe</p>
                <p style=" color: white; text-align: center; font-size: 32px;">El código de <%=ciudadano.getNombre()%> <%=ciudadano.getApellido()%> es <%=ciudadano.getId()%>. No lo pierda </p>
            </div>
            <% } else {%>
            <div class="col-8" >
                <p style="margin-top: 120px; color: white; text-align: center">Ha habido un error en su solicitud, null</p>
            </div>
            <% }%>
