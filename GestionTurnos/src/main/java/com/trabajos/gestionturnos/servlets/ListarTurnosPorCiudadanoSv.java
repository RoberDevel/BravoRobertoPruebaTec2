...
@WebServlet(name = "ListarTurnosPorCiudadanoSv", urlPatterns = {"/ListarTurnosPorCiudadanoSv"})
public class ListarTurnosPorCiudadanoSv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Ciudadano ciudadano = controladora.traerCiudadano(Long.valueOf(request.getParameter("id")));
